...
// Authentication
export const login = (credentials) => api.post('/login', new URLSearchParams(credentials)).then(res => res.data);
export const register = (data) => api.post('/register', data).then(res => res.data);

// Shelter
export const addApiKey = (data) => api.post('/add-api-key', data).then(res => res.data);
...
// Descriptions
export const generateDescription = (id) => api.post(`/animals/${id}/generate-description`).then(res => res.data);
